 ...
 **/
void updateOpenmpPoisson(Connection *connection, void *_data, real *buffer, uinteger_t *firedTable, uinteger_t *firedTableSizes, size_t firedTableCap, size_t num, size_t start_id, int time)
{
...
void updatePthreadPoisson(Connection *connection, void *_data, real *buffer, uinteger_t *firedTable, uinteger_t *firedTableSizes, size_t firedTableCap, size_t num, size_t start_id, int time, int thread_num, int thread_id, pthread_barrier_t &pthread_barrier)
{
}
