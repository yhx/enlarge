...
do
    dir_name="strong_circle_$node_num"
    mkdir $dir_name
    cd $dir_name
    ...
    mpirun -n $node_num --hostfile ../../../openmpi1.config -mca btl_tcp_if_include eno1 ../../../spack_run.sh ../../../build/bin/pattern_circle_iaf_mpi_run $neuron_num $run_time 1 #>> $file_name
...
#     # with multi-level
#     mpirun -n $node_num --hostfile ../../../openmpi1.config -mca btl_tcp_if_include eno1 ../../../spack_run.sh ../../../build/bin/pattern_circle_iaf_mpi_run $cur_neuron_num $run_time 1
