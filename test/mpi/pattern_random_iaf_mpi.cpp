...
int main(int argc, char **argv)
{
    ...
    if (node_id == 0) {
        ...
        for (int i = 0; i < pop_num; ++i) {
            ...
            g[i] = c.createPopulation(1, N, IAFNeuron(dt, 1, 10.0, 250.0, 2e-3, -70.0, 376.0 * rand_num, 
        ...
        for (int i = 0; i < pop_num; ++i) {
            for (int j = 0; j < pop_num; ++j) {
                if (i != j && (real)(rand() % 10000) / 10000 < (real)(i+1)/pop_num ) {
                    int syn_num = 0;
                    idx_src_.clear();
                    idx_dst_.clear();
                    ...
                    real* weight = getConstArray((real)0.0, syn_num);
                    ...
                    for (int k = 0; k < idx_src_.size(); ++k) {
                        ...
                        real rand_num = (real)(rand() % 10000) / 10000 + 0.5;
                        weight[k] = (real) w / syn_num * rand_num * 200 * sign;
                    }
